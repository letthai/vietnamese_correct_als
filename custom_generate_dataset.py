...
data_file = "D:\\HMI_Lab\\vietnamese-correct-als\\data\\data50k.vi.txt"
 #"data/en.wikidump.processed.24m.txt" #
language = "vi"
num_lines = sum(1 for line in open(data_file, 'r', encoding="utf8"))
...
count = 0
datas = []
with open(language+".csv", "w" , encoding="utf8") as output:        
    with open(data_file,'r', encoding="utf8") as file:
...
with open(f"{language}.csv", "r", encoding="utf8") as input_file:
    input_file.write("text,summary\n")
